...
class ConfigSemanticKITTI:
    ...
    noise_init = 0.0  # noise initial parameter
...
class ConfigSensatUrban_ignore:
    k_n = 16  # KNN
    num_layers = 5  # Number of layers
    num_points = 65536  # Number of input points
...
class ConfigS3DIS:
    ...
    val_batch_size = 15  # batch_size during validation and test
    train_steps = 1000  # Number of steps per epochs
    val_steps = 200  # Number of validation steps per epoch
...
class ConfigToronto3D:
    ...
    max_epoch = 100  # maximum epoch during training
    learning_rate = 1e-2  # initial learning rate
    lr_decays = {i: 0.98 for i in range(0, 500)}  # decay rate of learning rate
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name, num_per_class=0, name='sqrt'):
        ...
        elif dataset_name == 'SensatUrban' or dataset_name == 'Toronto3D' or dataset_name == 'ScanNet':
